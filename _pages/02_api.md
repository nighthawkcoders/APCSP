        ...
        <p>
            ...
            <ul>
                ...
                <ul> 
                    ...
                    <li>PUT/PATCH => Update data (put replaces the old one, while patch adds to the existing data)</li>
                    <li>DELETE => Delete data</li>
                </ul>

                <li>REST endpoints are for a users resource that represents students and teachers in a system.</li>
                <ul> 
