...
- Install Homebrew from Terminal [https://brew.sh](https://brew.sh)
    ...
    - Make sure command starts with "return", this should provide output in terminal and could take a long time, 10-min, there could be a  prompt in the middle, at about 5-minutes
- Homebrew install a tool called "brew" which helps add and manage developer packages on MacOS
