...
- Provide a comment on this page, comments can be edited clicking on Time Stamp of post.
- My suggestion is comment link and/or personal Fastpages / GitHub pages aka "_post" share the following.
    - Provide link to personal Fastpages / GitHub pages running on github.io
    - Provide link to a new page (_posts) in your Fastpages project show use of  Markdown and/or HTML fragments
    - Provide link to your 1st Jupyter notebook (_notebooks) showing usage of Python
    - Capture image/screen capture of Fastpages project being used in an Integrated Development Environment (VS Studio)
