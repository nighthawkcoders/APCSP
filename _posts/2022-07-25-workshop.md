...
> Async session had a video that shared review of things we missed that filled some gaps that I thought were in order we followed.  Also, there is talk of Internet Simulator / Messaging System that may be good for illustration.  Do they provide code for these tools?  That would be a great thing to teach.  Looks like it works over sockets.
- [Paseo Circles of Identity]({{site.baseurl}}/images/paseocircles.png)
