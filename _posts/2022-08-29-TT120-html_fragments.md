...
description: HTML fragments are portions of code used in a greater coding system that enable functionality specific to task at hand.  Fragment in HTML are a way to abstract complexity.
